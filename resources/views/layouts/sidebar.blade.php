            ...
            @if (Auth::check() && Auth::user()->role === 'admin')
                <li>
                    <a href="/contact-management"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Contact Management</span>
                    </a>
                </li>
            @endif
            @if (Auth::check() && Auth::user()->role === 'admin')
                <li>
                    <a href="/report-pumping"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Laporan Pumping</span>
                    </a>
                </li>
            @endif
            @if (Auth::check() && Auth::user()->role === 'mother')
                <li>
                    <a href="/my-report-pumping"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">My Report Pumping</span>
                    </a>
                </li>
            @endif
            @if (Auth::check() && Auth::user()->role === 'mother')
                <li>
                    <a href="/create-my-report"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Create Report Pumping</span>
                    </a>
                </li>
            @endif
            <li>
